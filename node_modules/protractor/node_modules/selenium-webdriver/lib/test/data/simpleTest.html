...
<p id="inline">This <span id="inlinespan">    line has <em>text</em>	</span> within elements that are meant to be
    displayed
...
<div id="twoblocks"><p>Some text</p>

    <p>Some more text</p></div>

<div id="nestedblocks">Cheese
    <div><p>Some text</p>
...
<div id="collapsingtext"><span></span>
...
<div style="text-indent:80%"><a href="resultPage.html" id="multilinelink">this link should break<br/>on multiple
    lines</a></div>
...
<table id="wrappingtext">
    <tbody>
    <tr>
        <td style="width: 10px;"><span>beforeSpace</span><span> </span><span>afterSpace</span></td>
    </tr>
    </tbody>
</table>
