 ...
 */
webdriver.testing.jsunit.TestRunner.prototype.takeScreenshot = function (driver, opt_label) {
 ...
 *     screenshot with.
 */
webdriver.testing.jsunit.TestRunner.prototype.saveImage = function (data, opt_label) {
    if (!this.isInitialized()) {
        throw Error(
            'The test runner must be initialized before it may be used to' +
            ' save images');
