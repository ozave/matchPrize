 ...
 * @type {boolean}
 */
goog.testing.TestCase.IS_IE = typeof opera == 'undefined' && !!goog.global.navigator &&
 ...
 * @private
 */
goog.testing.TestCase.prototype.invokeTestFunction_ = function (fn, onSuccess, onFailure) {
    try {
...
goog.testing.TestCase.prototype.finishTestInvocation_ = function (opt_error) {
    ...
    if (!(this.curTest_.name in this.result_.resultsByName) || !this.result_.resultsByName[this.curTest_.name].length) {
